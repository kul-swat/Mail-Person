...
class Ui_BodyWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Move the files"))
    ...
    def save_all(self):
        ...
        file_name, _ = QtWidgets.QFileDialog.getOpenFileName(None,'Choose Subject file')
        copyfile(file_name, "Subject.txt")
        file_name, _ = QtWidgets.QFileDialog.getOpenFileName(None,'Choose Body file')
        copyfile(file_name, "Body.txt")
